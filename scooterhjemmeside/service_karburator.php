...
$metadescription = "service af karburator på scooter (rensning og justering af tomgang, blandingsskrue, svømmer højde)";
...
rens karburator
' => '
Til rensning af karburatoren kan bruges '.ahref('smorelse.php#karburatorrens', 'karburatorrens').' og trykluft.
Har man ikke andet kan man bruge benzin men pas på brandfaren og brug kun benzin i meget små mængder.

Inden rengøring er det en god ide at fjerne dele af gummi fordi jeg mener at have læst at de måske ikke kan tåle rengøringsmidler og måske hæver (bliver større) hvis de kommer i kontakt med bestemte stoffer.

Skru bunden af karburatoren.
Der ligger gerne noget bundfald som kan fjernes med karburatorrens.
...
Fjern svømmeren og nåleventilen og kontroller at spidsen på nåleventilen er i god stand.
...
'.ahref('http://repvideo.lars-mc.dk/repvideo/popupvideo.php?sptlv=1190296519', 'Komplet karburatorrensning... (repvideo.lars-mc.dk)').'.
...
Hvis baghjulet drejer rundt i tomgang så vil koblingen blive slidt unødigt og man ville skulle holde bremse inden for at stoppe scooteren i at kører.

Drej og giv slip på gashåndtaget og bemærk hvordan motoren falder tilbage til tomgang.

Finjuster et par gange indtil du finder den helt rigtige indstilling.

Justering skal foregå mens motoren er varm og den automatiske choker er fuld lukket.
...
Det kan være lidt irriterende at baghjulet drejer rundt når man lige har startet scooteren men så må man finjuster sig frem til en løsning man er tilfreds med.
...
Motoren kan gå istå når man holder for rødt i et lyskryds.
...
Man skal holde bremsen inde når man holder for rødt i et lyskryds da scooteren ellers vil køre frem.
...
Skru blandingsskruen stille og roligt ind indtil den går i bund (ikke hårdt).
...
Dette kaldes grund indstillingen.
...
Når der i manualen står at blandingsskruen skal være 1,5 til 2,5 åben så betyder det at du først skal skrue den ibund også skal den skrues 1,5 til 2,5 omgange tilbage. Altså 2 omgange ud +/- en halv omgang.

Når blandingsskruen skrues ibund så drej stille og roligt indtil du kan mærke den stopper.
Blandingsskruen har et meget fint gevind som formodentligt let kan ødelægges hvis man drejer for hårdt.
...
'.visbilled('1', 'billed0627.jpg', 'karburator svømmer piaggio fly 150 cm³', false, true).'
...
Vægten af svømmeren kan presse ned på nåleventilen som har en fjeder inden i så højden måles forkert hvis karburatoren vender på hovedet.
Derfor kan man holde karburatoren skævt sådan at nåleventilen lukker for hullet men uden at alt vægten fra svømmeren presser yderligere på nåleventilen.
