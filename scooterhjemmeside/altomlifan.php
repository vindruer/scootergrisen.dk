...
'lifanlf50qt26a' => array(
     ...
     'specielt'            => array(
       'besked'            => ens('besked', '
sæde og bagende kan foldes sammen
EF-Type-godkendelsenr.:	e24*2002/24*0188*00
victory one V1 (motor er på siden)
wind dream (ligende model hvor motor er i navnet)

måske Genata (www.genata.com.cn)
måske ****GUO
måske Guangyu Motorcycle Manufacture Co., Ltd

CoC Make:
V1 sports, xing guo, lifan,
wkbikes, turbox, sfenx, quadix,
my-ecomobile, far-eastern power,
genata, ekomoters, actionbikes,
seven motor, guangyou
', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'lifan XG1500DQ', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'LF1500DQ', '', '', '')
      ,'varianter'         => ens('varianter', 'LF1500DQG00', '', '', '')
      ,'pris'              => ens('pris', '12995', '', '', '')
      ,'hastighed'         => ens('hastighed', '45', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', 'http://xn--blbr-roah.nu/shop/shop/product/show_product.asp?Product_ID=131&GroupID=10&SubGroupID=0&search=&pageindex=1&menu=3&submenu=0&lang=da', '', '', '')
      ...
      ,'sædehøjde'         => ens('sædehøjde', '', '', '', '')
      ,'frihøjde'          => ens('frihøjde', '', '', '', '')
      ,'akselafstand'      => ens('akselafstand', '1150', '', '', '(i følge alibaba.com)')
      ...
      ,'forbrug'           => ens('forbrug', '', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '', '14', '', '')
      ,'fælgbag'           => ens('fælg', '', '14', '', '')
      ,'dækfor'            => ens('dæk1', '80', '80', '14', 'slangeløs')
      ,'dækbag'            => ens('dæk1', '80', '80', '14', 'slangeløs')
      ,'dæktrykfor'        => ens('dæktryk', '', '', '', '')
      ,'dæktrykbag'        => ens('dæktryk', '', '', '', '')
      ,'affjedringfor'     => ens('affjedringfor', '', '', '', '')
      ,'affjedringbag'     => ens('affjedringbag', '', '', '', '')
      ,'bremserfor'        => ens('bremser', 'skive', '220', 'hudraulisk', '')
      ...
      ,'venderadius'       => ens('venderadius', '', '', '', '')
       ...
       'starterbatteri'    => ens('starterbatteri', '', '', '', '')
      ,'batterispec1'      => ens('batterispec1', '48', '20', '', 'lithium (i følge blåbær.nu)') . '<br>' . ens('batterispec1', '48', '24', '1150 Wh', 'lithium (i følge alibaba.com)')
      ,'batterispec2'      => ens('batterispec2', '', '', '', '')
      ,'batterivægt'       => ens('batterivægt', '', '', '', '')
      ,'batterilevetid'    => ens('batterilevetid', '', '', '', '')
      ,'generator'         => ens('generator', '', '', '', '')
      ...
      ,'lysinstrument'     => ens('lys', '', '', '', '')
      ,'oplader'           => ens('oplader', '', '', '', '')
      ,'ladetid'           => ens('ladetid', '2', '', '', '')
      ,'rækkevidde'        => ens('rækkevidde', '', 'op til 85', '30', '')
      ,'controller'        => ens('controller', '', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', 'aluminium', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LF3DTG005DC000082 (stor knallert SH373)', '', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', 'minimum 50', '', '', '(i følge skat.dk)') . ens('vægtkørerklar', '45', '', '', '(i følge blåbær.nu)')
      ,'vægttotal'         => ens('vægttotal', '130', '', '', '')
      ,'bæreevne'          => ens('bæreevne', '150', '', '', '')
      ,'luftfiltertype'    => ens('luftfiltertype', '', '', '', '')
      ,'stigeevne'         => ens('stigeevne', 'max 18', 'grader', '', '(i følge blåbær.nu)') . '<br>' . ens('stigeevne', '>=15', 'grader', '', '(i følge alibaba.com)')
      ,'medfølger'         => ens('medfølger', '', '', '', '')
      ,'bremsevæske'       => ens('bremsevæske', '', '', '', '')
      ,'støj'              => ens('støj', '', '', '', '')
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', '', '', '', '')
      ,'producent'         => ens('producent', 'Chongqing Lifan Industry Co., Ltd.', '', '', '')
      ,'andet'             => ens('andet', 'stik til iPhone, USB, hukommelseskort', '', '', '')
...
'download' => array(
    'XG1500DQ CoC'    => 'lifan_xg1500dq_coc.jpg'
//   ,''    => ''
