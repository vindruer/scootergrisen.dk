...
$title = "tomos knallert med 50 cm³ motor";
$overskrift = "tomos";
...
'tomosclassic' => array(
     ...
     'specielt'            => array(
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '1,0', 'kw', '', '(ifølge 30 km/t typegodkendelse)')
      ,'moment'            => ens('moment', '', '', '', '')
      ...
      ,'forbrug'           => ens('forbrug', '', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '1.35', '16', '', '')
      ,'fælgbag'           => ens('fælg', '1.35', '16', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'ZZ1A34CAA01', 'XMLA34CAA01A16', '', '')
      ...
      ,'begrænsstelnum'    => ens('begrænsstelnum', '', 'Tegn nr. 7 & 8 i stelnummeret er "4C" og angiver den maksimale hastighed = 30 km/t. (hmm det passer vist ikke eller hvad)', '', '')
      ,'begrænsandet'      => ens('begrænsandet', '', 'Begrænsning i cylinder og udstødning', '', '')
...
//   ,''    => ''
    ...
    'tomos classic A3 30 km/t E17111 (e12*92/61*0011)'           => 'typegodkendelser/Tomos%20Classic%20%28E17111%29%20udstedt%2022-04-2008.pdf'
