...
$title = "secma scootere med 50 cm³ og elektrisk motor";
$overskrift = "secma";
...
'secmafunelec' => array(
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'secma fun elec', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'CSELEC', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '18', '', '', '(ifølge typegodkendelse)')
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')

   ),'motor'               => array(
       'motormodel'        => ens('motormodel', 'Imperial Electric P56MD019', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '1,5', 'kw', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ...
      ,'bremserfor'        => ens('bremser', 'tromle', '110', '', '2 styk')
      ,'bremserbag'        => ens('bremser', 'tromle', '110', '', '2 styk')
      ,'eger'              => ens('eger', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'VMTCSELEC', '', '', '')
      ...
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Jydsk Handelsselskab', '', '', '')
     ...
     'specielt'            => array(
       'besked'            => ens('besked', 'denne model har 3 bærende hjul plus 2 ekstra mindre støttehjul', 'den findes også med 4 bærende hjul men ikke i danmark og ikke som stor knallert så vidt jeg ved', 'Her er et link til en dansk hjemmeside med massere af billeder af Secma Funtech : '.ahref('http://www.prematur.dk', 'Onkel morfar').'', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'secma fun tech', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'CSBUG1', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ...
      ,'affjedringfor'     => ens('affjedringfor', '', '', '', '')
      ,'affjedringbag'     => ens('affjedringbag', '', '', '', '')
      ,'bremserfor'        => ens('bremser', 'tromle', '110', '', '(2 styks)')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'VMTCSBUG101', 'VMTCSBUG101001389 (SH126 E09620)', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Jydsk Handelsselskab (Godkendelsen har tidligere været udstedt til: Jysk Tagdækning v/Tonny Falk-Hansen, Drejervej 6, 6600 Vejen.)', '', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
      ...
      ,'begrænsruller'     => ens('begrænsruller', '', '', '', '')
      ,'begrænsindsug'     => ens('begrænsindsug', '', '', '', '')
      ,'begrænsudstødning' => ens('begrænsudstødning', '', '', 'Bøsning med central lysning på ø 20 mm og 2 huller i yderkant med ø 5 mm, svejset i flange for udstødningsrør.', '')
      ,'begrænsstelnum'    => ens('begrænsstelnum', '', '', '', '')
      ,'begrænsandet'      => ens('begrænsandet', '', '', '', '')
...
//   ,'' => ''
    ...
    'Secma Fun Tech 45 km/t E9620 (E09620 ?) (e13*92/61*0012)'   => 'typegodkendelser/Secma%20Fun%20Tech%20%28E9620%29%20udstedt%2011-01-1999.pdf'
