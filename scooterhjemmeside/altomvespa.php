...
'vespaet2' => array(
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'vespa ET2', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'piaggio vespa ET2', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'ZAPC1600000070798 A08925-01', 'ZAPC1600000118047 A08925-01', '', '')
   ...
   'generelt'              => array(
      ...
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', 'http://www.italianbikestore.dk', 'http://www.pgdanmark.dk', '', '')

   ),'motor'               => array(
       'motormodel'        => ens('motormodel', 'C383M', '', '', '')
      ,'motortype'         => ens('motortype', '4 takt', '', '', '')
      ,'elmotorspec'       => ens('elmotorspec', '', '', '', '')
      ,'volume'            => ens('volume', '49,4', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '39,1', '', '', '')
      ...
      ,'forbrug'           => ens('forbrug', '', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '', '', '', '')
      ,'fælgbag'           => ens('fælg', '', '', '', '')
      ,'dækfor'            => ens('dæk1', '110', '70', '11', '')
      ,'dækbag'            => ens('dæk1', '120', '70', '10', '')
      ,'dæktrykfor'        => ens('dæktryk', '', '', '', '')
      ,'dæktrykbag'        => ens('dæktryk', '', '', '', '')
      ,'affjedringfor'     => ens('affjedringfor', 'enkelt sidet traling link med hydraulisk støddæmper', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'ZAPC38300', 'ZAPC3810400001 (er vist til Piaggio LX 2 takt)', 'ZAPC3840000 (Piaggio LX, ikke sikkert det er til denne model)', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '104', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ,'vægttotal'         => ens('vægttotal', '', '', '', '')
      ,'bæreevne'          => ens('bæreevne', '', '', '', '')
      ,'luftfiltertype'    => ens('luftfiltertype', '', '', '', '')
