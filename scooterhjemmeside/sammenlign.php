...
$title = "sammenlign scootere/knallerter med 2 takt, 4 takt og elektrisk motor";
$overskrift = "sammenlign scootere/knallerter med 2 takt, 4 takt og elektrisk motor";
...
box(array('200', '150', '150', '150')
   ,array(
      ...
      ,array('støj'                    ,'mest'          ,'mindre'          ,'mindst')
      ,array('udstødning'              ,'mest'          ,'mindre'          ,'ingen')
      ...
      ,array('acceleration'            ,'hurtig'        ,'langsom'         ,'hurtigst')
      ,array('tændrør giver gnist'     ,'hver gang stemplet er i top'     ,'hver anden gang stemplet er i top'          ,'')
...
' => '
Her følger nogle af de fordele og ulemper der er ved elektriske scootere i forhold til scootere med forbrændingsmotor.
'
