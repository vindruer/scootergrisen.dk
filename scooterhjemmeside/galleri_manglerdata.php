...
$title = "galleri for modeller som mangler data";
$overskrift = "galleri for modeller som mangler data";
...
introduktion
' => '
På denne galleri side har du en oversigt over modellerne fra '.ahref('manglerdata.php', 'Modeller som mangler data-siden').' som er modeller jeg næsten ikke har noget data på. Nogen af dem har jeg ikke engang billeder på.
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'manglerdata.php', 'yiyingsampra', 'yiying sampra')
))
