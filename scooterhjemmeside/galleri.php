...
$setup['sideikon']               = 'ikoner/ikon_galleri2.png';
...
$kort = basename($_SERVER['SCRIPT_NAME']) . '#';
...
' => ''
.galleriholder(array(
    galleri('logo', $kort . 'a2b', 'logo_a2b', 'a2b')
   ,galleri('logo', $kort . 'adly', 'logo_adly', 'adly')
   ,galleri('logo', $kort . 'agm', 'logo_agm', 'agm')
   ,galleri('logo', $kort . 'amp',  'logo_amp', 'amp')
   ,galleri('logo', $kort . 'apollo',  'logo_apollo', 'apollo')
   ,galleri('logo', $kort . 'aprilia',  'logo_aprilia', 'aprilia')
   ,galleri('logo', $kort . 'atala',  'logo_atala', 'atala')
   ,galleri('logo', $kort . 'avanti',  'logo_avanti', 'avanti')
   ,galleri('logo', $kort . 'baotian',  'logo_baotian', 'baotian')
   ,galleri('logo', $kort . 'benzhou_yiying',  'logo_benzhouyiying', 'benzhou yiying')
   ,galleri('logo', $kort . 'beta',  'logo_beta', 'beta')
   ,galleri('logo', $kort . 'busetto',  'logo_busetto', 'busetto')
   ,galleri('logo', $kort . 'cpi',  'logo_cpi', 'cpi')
   ,galleri('logo', $kort . 'derbi',  'logo_derbi', 'derbi')
   ,galleri('logo', $kort . 'earthenergy',  'logo_earthenergy', 'earthenergy')
   ,galleri('logo', $kort . 'ebretti',  'logo_ebretti', 'ebretti')
   ,galleri('logo', $kort . 'ego',  'logo_ego', 'ego')
   ,galleri('logo', $kort . 'emax',  'logo_emax', 'e-max')
   ,galleri('logo', $kort . 'evt',  'logo_evt', 'evt')
   ,galleri('logo', $kort . 'e_ton',  'logo_eton', 'e-ton')
   ,galleri('logo', $kort . 'generic',  'logo_generic', 'generic')
   ,galleri('logo', $kort . 'giantco',  'logo_giantco', 'giantco')
   ,galleri('logo', $kort . 'gilera',  'logo_gilera', 'gilera')
   ,galleri('logo', $kort . 'govecs',  'logo_govecs', 'govecs')
   ,galleri('logo', $kort . 'grace',  'logo_grace', 'grace')
   ,galleri('logo', $kort . 'hero_majestic',  'logo_heromajestic', 'hero majestic')
   ,galleri('logo', $kort . 'honda',  'logo_honda', 'honda')
   ,galleri('logo', $kort . 'italjet',  'logo_italjet', 'italjet')
   ,galleri('logo', $kort . 'jincheng',  'logo_jincheng', 'jincheng')
   ,galleri('logo', $kort . 'jinlun',  'logo_jinlun', 'jinlun')
   ,galleri('logo', $kort . 'keeway',  'logo_keeway', 'keeway')
   ,galleri('logo', $kort . 'kinroad',  'logo_kinroad', 'kinroad')
   ,galleri('logo', $kort . 'kreidler',  'logo_kreidler', 'kreidler')
   ,galleri('logo', $kort . 'kymco',  'logo_kymco', 'kymco')
   ,galleri('logo', $kort . 'lifan',  'logo_lifan', 'lifan')
   ,galleri('logo', $kort . 'longjia',  'logo_longjia', 'longjia')
   ,galleri('logo', $kort . 'luyuan',  'logo_luyuan', 'luyuan')
   ,galleri('logo', $kort . 'lynx',  'logo_lynx', 'lynx')
   ,galleri('logo', $kort . 'malaguti',  'logo_malaguti', 'malaguti')
   ,galleri('logo', $kort . 'motor_mania',  'logo_motormania', 'motor mania')
   ,galleri('logo', $kort . 'nicom',  'logo_nicom', 'nicom')
   ,galleri('logo', $kort . 'nordic_e_bike',  'logo_nordicebike', 'nordic e-bike')
   ,galleri('logo', $kort . 'norsjo',  'logo_norsjo', 'norsjö')
   ,galleri('logo', $kort . 'peugeot',  'logo_peugeot', 'peugeot')
   ,galleri('logo', $kort . 'pgo',  'logo_pgo', 'PGO')
   ,galleri('logo', $kort . 'piaggio',  'logo_piaggio', 'piaggio')
   ,galleri('logo', $kort . 'puch',  'logo_puch', 'puch')
   ,galleri('logo', $kort . 'qingqi',  'logo_qingqi', 'qingqi')
   ,galleri('logo', $kort . 'regal_raptor',  'logo_regalraptor', 'regal raptor')
   ,galleri('logo', $kort . 'rieju',  'logo_rieju', 'rieju')
   ,galleri('logo', $kort . 'romet',  'logo_romet', 'romet')
   ,galleri('logo', $kort . 'sachs',  'logo_sachs', 'sachs')
   ,galleri('logo', $kort . 'secma',  'logo_secma', 'secma')
   ,galleri('logo', $kort . 'scoopie',  'logo_scoopie', 'scoopie')
   ,galleri('logo', $kort . 'skyteam',  'logo_skyteam', 'skyteam')
   ,galleri('logo', $kort . 'solex',  'logo_solex', 'solex')
   ,galleri('logo', $kort . 'solo',  'logo_solo', 'solo')
   ,galleri('logo', $kort . 'suzuki',  'logo_suzuki', 'suzuki')
   ,galleri('logo', $kort . 'swap',  'logo_swap', 'swap')
   ,galleri('logo', $kort . 'sym',  'logo_sym', 'sym')
   ,galleri('logo', $kort . 'tante_paula',  'logo_tantepaula', 'tante paula')
   ,galleri('logo', $kort . 'texas',  'logo_texas', 'texas')
   ,galleri('logo', $kort . 'tgb',  'logo_tgb', 'tgb')
   ,galleri('logo', $kort . 'tms',  'logo_tms', 'tms')
   ,galleri('logo', $kort . 'tomos',  'logo_tomos', 'tomos')
   ,galleri('logo', $kort . 'trilet',  'logo_trilet', 'trilet')
   ,galleri('logo', $kort . 'varg',  'logo_varg', 'varg')
   ,galleri('logo', $kort . 'vespa',  'logo_vespa', 'vespa')
   ,galleri('logo', $kort . 'xingyue',  'logo_xingyue', 'xingyue')
   ,galleri('logo', $kort . 'yamaha',  'logo_yamaha', 'yamaha')
   ,galleri('logo', $kort . 'yamasaki',  'logo_yamasaki', 'yamasaki')
   ,galleri('logo', $kort . 'yiben',  'logo_yiben', 'yiben')
   ,galleri('logo', $kort . 'zhenhua',  'logo_zhenhua', 'zhenhua')
   ,galleri('logo', $kort . 'zongshen',  'logo_zongshen', 'zongshen')
   ,galleri('logo', $kort . 'andre_merker',  'logo_andre', 'andre mærker')
))
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'altomadly.php', 'adlynoble', 'Adly Noble')
))
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'altomgilera.php', 'gilerarunnerpurejet', 'Gilera Runner PureJet')
...
' => ''
.galleriholder(array(
    galleri('scooter', 'altomgrace.php', 'graceone', 'Grace One')
))
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'altomkymco.php', 'kymcosuper84t', 'Kymco Super 8 4T')
   ,galleri('scooter', 'altomkymco.php', 'kymcosuper82t', 'Kymco Super 8 2T')
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'altomlifan.php', 'lifanxg1500dq', 'Lifan XG1500DQ')
))
...
.galleriholder(array(
   ...
   ,galleri('scooter', 'altomxingyue.php', 'xingyuedm82', 'Xingyue DM82')
