...
$title = "jinlun scootere med 50 cm³ motor";
$overskrift = "jinlun";
...
'jinlunjl50qt5' => array(
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'Jinlun JL50QT-5', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'JL50QT-5', '', '', '')
      ...
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', 'Jinlun JL139QMB', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '2,3', 'kw', '7500', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'deni PD18J', '', '', '(hoveddyse 85 ?)')
      ...
      ,'affjedringbag'     => ens('affjedringbag', '1 fjeder', '', '', '')
      ,'bremserfor'        => ens('bremser', 'skive', '155', '', '')
      ,'bremserbag'        => ens('bremser', 'tromle', '105', '', '')
      ,'eger'              => ens('eger', '', '', '')
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'Jinlun JL50QT-7', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'JL50QT-7', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '45', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ...
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'deni 18J', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ,'tændrør'           => ens('tændrør', '', '', '', '')
...
'download' => array(
    'Jinlun JL50QT-5 reservedele' => 'jinlun_jl50qt5_reservedele.pdf'

),'typegodkendelser' => array(
    'Jinlun JL50QT-5 45 km/t E14800 (e4*2002/24*0406)' => 'typegodkendelser/Jinlun%20JL50QT-5%20%28E14800%29%20udstedt%2009-01-2006.pdf'
   ,'Jinlun JL50QT-7 45 km/t E14799 (e4*2002/24*0526)' => 'typegodkendelser/Jinlun%20JL50QT-7%20%28E14799%29%20udstedt%2009-01-2006.pdf'
