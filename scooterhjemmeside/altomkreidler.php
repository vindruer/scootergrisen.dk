...
$title = "kreidler scootere med 50 cm³ og elektrisk motor";
$overskrift = "kreidler";
...
'kreidlergalacticaelectro' => array(

     'specielt'            => array(
       'besked'            => ens('besked', '', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'kreidler galactica electro', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'kreidler galactica 2.0 electro', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '3,4', 'kw', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ...
      ,'affjedringbag'     => ens('affjedringbag', 'hydraulisk støddæmper justerbar', '', '', '')
      ...
      ,'batterispec1'      => ens('batterispec1', '', '', 'lithium', '')
...
),'kreidlerhiker20electro' => array(

     'specielt'            => array(
       'besked'            => ens('besked', 'ser ud til at have samme specifikationer som kreidler hiker amaze men ved anderledes plastikdele. Blandt andet er forlygten anderledes og sideskjoldende ved sædet', 'kreidler hiker 2.0 electro er måske en nyere udgave end kreidler hiker amaze', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'kreidler hiker 2.0 electro', '', '', '')
...
),'kreidlerhikeramaze' => array(

   'generelt'              => array(
       'model'             => ens('model', 'kreidler hiker amaze', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'kreidler RMC-E hiker amaze', '', '', '')
      ,'scootertype'       => ens('scootertype', 'MSG', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '16495', '16995', '', '')
      ,'hastighed'         => ens('hastighed', '30 og 45', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', '', '', '', '')
      ,'motortype'         => ens('motortype', 'elektrisk', '', '', '')
      ,'elmotorspec'       => ens('elmotorspec', '48', '', 'nav', '')
      ,'volume'            => ens('volume', '', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '', '', '', '')
      ,'slaglængde'        => ens('slaglængde', '', '', '', '')
      ...
      ,'venderadius'       => ens('venderadius', '', '', '', '')
       ...
       'starterbatteri'    => ens('starterbatteri', '', '', '', '')
      ,'batterispec1'      => ens('batterispec1', '48', '40', 'silicone / silicium', 'aftageligt med håndtag')
      ,'batterispec2'      => ens('batterispec2', '', '', '', '')
      ,'batterivægt'       => ens('batterivægt', '', '', '', '')
      ,'batterilevetid'    => ens('batterilevetid', '', '', '', '')
      ,'generator'         => ens('generator', '', '', '', '')
      ...
      ,'lysnummerplade'    => ens('lys', '', '', '', '')
      ,'lysinstrument'     => ens('lys', '', '', '', '')
      ,'oplader'           => ens('oplader', '', '8', '', '')
      ,'ladetid'           => ens('ladetid', '', '', '', '')
      ,'rækkevidde'        => ens('rækkevidde', '', '55', '', '') . '<br>' . ens('rækkevidde', '', '65', '', '(ifølge kreidler.net)')
      ,'controller'        => ens('controller', '', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'WK15G01V0AY040', 'WK1SG0053AY010', 'WK1SG00V1AY010', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '90', 'uden batterier', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '145', 'med batterier', '', '')
      ,'vægttotal'         => ens('vægttotal', '300', '', '', '')
      ,'bæreevne'          => ens('bæreevne', '', '', '', '')
      ,'luftfiltertype'    => ens('luftfiltertype', '', '', '', '')
      ,'stigeevne'         => ens('stigeevne', '', '', '', '')
      ...
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'InoTrade v/Jack Weilmann', '', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
      ...
      ,'begrænsudstødning' => ens('begrænsudstødning', '', '', '', '')
      ,'begrænsstelnum'    => ens('begrænsstelnum', '', '', '', '')
      ,'begrænsandet'      => ens('begrænsandet', 'elektronisk', '', '', '')

   )

),'kreidlerjigger3hjul' => array(

     'specielt'            => array(
       'besked'            => ens('besked', '', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'Kreidler Jigger 3 hjul', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', '', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '31995', '', '', '')
...
),'kreidlerjiggercity' => array(

     'specielt'            => array(
       'besked'            => ens('besked', '', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'kreidler jigger city', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', '', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '8995', '', '', '')
      ...
      ,'tomgang'           => ens('tomgang', '', '', '', '')
      ,'nomieffektogheste' => ens('nomieffektogheste', '', '', '', '')
      ,'maxeffektogheste'  => ens('maxeffektogheste', '2,4', 'kw', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', '', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ...
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '87', '', '', '')
      ,'vægttotal'         => ens('vægttotal', '247', '', '', '')
      ,'bæreevne'          => ens('bæreevne', '', '', '', '')
      ,'luftfiltertype'    => ens('luftfiltertype', '', '', '', '')
      ,'stigeevne'         => ens('stigeevne', '', '', '', '')
      ,'medfølger'         => ens('medfølger', '', '', '', '')
      ...
      ,'importør'          => ens('importør', '', '', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', 'maksimalt o/min : 6300', '', '', '')
...
'download' => array(
    'Kreidler Mo-Ped 2-speed automatic engine servicemanual' => 'kreidler_moped_2_speed_automatic_engine_servicemanual.pdf'

),'typegodkendelser' => array(
    'hiker amaze 45 km/t E18065 (e9*2002/24*0373)' => 'typegodkendelser/Kreidler%20Hiker%20Amaze%20%28E18065%29%20udstedt%2005-03-2010.pdf'
   ,'hiker electro 30 km/t E19160 (e9*2002/24*0373)' => 'typegodkendelser/Kreidler%20Hiker%20Electro%20(E19160)%20udstedt%2024-06-2011.pdf'
