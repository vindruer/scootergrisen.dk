...
$title = "AGM scootere med 50 cm³ og hybrid motor";
$overskrift = "AGM";
...
'agmbella' => array(
     ...
     'specielt'            => array(
      ...
      ,'tomgang'           => ens('tomgang', '', '', '', '')
      ,'nomieffektogheste' => ens('nomieffektogheste', '', '', '', '')
      ,'maxeffektogheste'  => ens('maxeffektogheste', '2,9', 'hk', '', '') . '<br>' . ens('maxeffektogheste', '2,2', 'kw', '', '(i følge både 25 og 45 km/t typegodkendelse)')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', '', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ...
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Søndergaard Autoimport v/Steen Søndergaard-Hansen', '', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')

   ),'begrænsninger'       => array(
       'begrænstransmis'   => ens('begrænstransmis', 'Centrifugalregulering i variator', '', 'Centrifugalregulering i variator', '')
      ,'begrænstænding'    => ens('begrænstænding', '', '', '', '')
      ,'begrænskarburator' => ens('begrænskarburator', '', '', '', '')
      ,'begrænsluftfilter' => ens('begrænsluftfilter', '', '', '', '')
      ,'begrænscontroller' => ens('begrænscontroller', '', '', '', '')
...
'download' => array(
   ...
   ,'AGM Vintage KF50 45 km/t E18202 (e11*2002/24*0913)'            => 'typegodkendelser/AGM%20-%20%28E18202%29%20udstedt%2017-05-2010.pdf'
   ,'AGM Vintage KF50 25 km/t E18203 (e11*2002/24*0913)'            => 'typegodkendelser/AGM%20-%20%28E18203%29%20udstedt%2017-05-2010.pdf'
