...
$title = "romet knallert med 50 cm³ motor";
$overskrift = "romet";
...
'rometogar900' => array(
   ...
   'generelt'              => array(
       'model'             => ens('model', 'romet ogar 900 r racing', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'måske longbo LB50Q-5', '', '', '')
      ...
      ,'akselafstand'      => ens('akselafstand', '1220', '', '', '')
       ...
       'benzin'            => ens('benzin', '', '', '', '')
      ,'benzintank'        => ens('benzintank', '5', '(reservetank : 0,7 liter)', '', '')
      ,'forbrug'           => ens('forbrug', '', '', '', '')

   ),'hjul'                => array(
       'fælgfor'           => ens('fælg', '', '', '', '')
      ,'fælgbag'           => ens('fælg', '', '', '', '')
      ,'dækfor'            => ens('dæk1', '70', '90', '17', '')
      ,'dækbag'            => ens('dæk1', '80', '90', '17', '')
      ...
      ,'producent'         => ens('producent', 'Chuanl Motorcycle Manufacturing Co., Ltd.', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
