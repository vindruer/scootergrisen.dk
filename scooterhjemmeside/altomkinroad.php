...
'kinroadchopper' => array(

   'generelt'              => array(
       'model'             => ens('model', 'kinroad chopper', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'kinroad prince', 'xintian', '', '')
      ,'scootertype'       => ens('scootertype', 'XT50Q XT50Q-A', '
XT50Q-00 (dobbeltsæde)<br>
...
', '', '')
      ...
      ,'hastighed'         => ens('hastighed', '30 og 45', '(i typegodkendelserne står 27 og 28 km/t ved lille knallert)', '', '')
      ,'farver'            => ens('farver', 'sort-gul sort-sølv', '', '', '')
      ,'forhandlere'       => ens('forhandlere', 'http://www.daxshoppen.dk', 'http://www.gaardeautoservice.dk', 'http://www.pitstar.dk/', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '0,9', 'kw', '', '') . ens('maxeffektogheste', '1,2', 'hk', '', '(30 km/t ifølge daxshoppen.dk)')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'DENI PZ17G (27 km/t)', 'JINGKE (45 km/t)', '', '')
      ...
      ,'bredde'            => ens('bredde', '775', '', '', '')
      ,'højde'             => ens('højde', '1160', '', '', '')
      ,'sædehøjde'         => ens('sædehøjde', '580-630', '', '', '')
      ,'frihøjde'          => ens('frihøjde', '', '', '', '')
      ,'akselafstand'      => ens('akselafstand', '1340', '', '', '')
      ...
      ,'forbrug'           => ens('forbrug', '30-40', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '1.50 eller 2.50', '17', '', 'fås med forskellig forfælg')
      ,'fælgbag'           => ens('fælg', '2.50 eller 2.75 eller 4.00', '12 eller 15', '', '')
      ,'dækfor'            => ens('dæk2', '2.50', '17', '', '')
      ,'dækbag'            => ens('dæk2', '4.00', '12 eller 15', '', '(måske 4.50 x 14" eller 4.50 x 12")')
      ...
      ,'tandhjulfor'       => ens('tandhjulfor', '27/30 km/t : 13', '45 km/t : 14', '', '')
      ,'tandhjulbag'       => ens('tandhjulbag', '27/30 km/t : 46', '45 km/t : 38', '', '')
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')

   ),'ekstra'              => array(
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LBXPCB2BX8X LBXPCB2B29X070 (XT50Q-A-00) LBXPCBLA35X (45 km/t XT50Q-02 )', 'LBXPCB3A26X030238 (kinroad prince stor knallert)', 'LBXPCB2B29X070 (KINROAD PRINCE XT 50 Q-A-00)', '45 km/t : LBXPCBLA LBXPCB2B78X LBXPCB2B5AX LBXPCBL035X LBXPCB2B4AX040 LBXPCB2BX9X070') . 'LBXPCB2B1AX040 (lille knallert XT50Q-A-01)'
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '2', '', '', '')
      ,'vægttør'           => ens('vægttør', '87-90', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '95', '', '', '')
      ,'vægttotal'         => ens('vægttotal', '245', '', '', '')
      ,'bæreevne'          => ens('bæreevne', '170', '', '', 'XT50Q-02 (enkeltsæde) og XT50Q-03 (enkeltsæde)') . ens('bæreevne', '245-250', '', '', 'XT50Q-00 (dobbeltsæde) og XT50Q-01 (dobbeltsæde)')
      ,'luftfiltertype'    => ens('luftfiltertype', '', '', '', '')
      ,'stigeevne'         => ens('stigeevne', '', '', '', '')
      ,'medfølger'         => ens('medfølger', '', '', '', '')
      ,'bremsevæske'       => ens('bremsevæske', '', '', '', '')
      ,'støj'              => ens('støj', '82', '3000', '', '')
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Bike Danmark ApS', '', '', '')
      ,'producent'         => ens('producent', 'Kinroad Xintian Motorcycle Manufacture Co., Ltd.', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
      ...
      ,'begrænsstelnum'    => ens('begrænsstelnum', '', 'Tegn 6-8 i stelnummeret er BB og angiver den maksimale hastighed = 27 km/t', 'Tegn 6-8 i stelnummeret er B- L-A og angiver den maksimale hastighed = 45 km/t', '')
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'kinroad fresh wind', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LBXTC', 'LBXTABPA05X (stor knallert)', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
...
),'kinroadxt50qt2' => array(

     'specielt'            => array(
       'besked'            => ens('besked', '', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'kinroad windbell', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'kinroad little fish ?', '', '', '')
      ,'scootertype'       => ens('scootertype', 'XT50QT-2', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ...
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', 'Kinroad 139QMB', '', '', '')
      ,'motortype'         => ens('motortype', '4 takt', '', '', '')
      ,'elmotorspec'       => ens('elmotorspec', '', '', '', '')
      ,'volume'            => ens('volume', '', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '', '', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'WABRO', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ,'tændrør'           => ens('tændrør', '', '', '', '')
      ...
      ,'forbrug'           => ens('forbrug', '', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '2.10', '10', '', '')
      ,'fælgbag'           => ens('fælg', '2.10', '10', '', '')
      ...
      ,'affjedringfor'     => ens('affjedringfor', '', '', '', '')
      ,'affjedringbag'     => ens('affjedringbag', '', '', '', '')
      ,'bremserfor'        => ens('bremser', 'skive', '155', 'hydraulisk', '')
      ,'bremserbag'        => ens('bremser', 'tromle', '110', 'hydraulisk', '')
      ,'eger'              => ens('eger', '', '', '')
      ,'castervinkel'      => ens('castervinkel', '', '', '')
      ,'efterløb'          => ens('efterløb', '', '', '')
      ,'drejevinkel'       => ens('drejevinkel', '', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LBXTCBPA05X (stor knallert KINROAD WINDBELL XT50QT-2-01)', 'LBXTCBPA15X012398 (OM456)', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'House of Sourcing', 'Bike Danmark Aps', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
...
),'kinroadxt50qt2a' => array(

     'specielt'            => array(
       'besked'            => ens('besked', '', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'kinroad little fish / super fish ?', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'XT50QT-2A', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '28', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '', '', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'DENI PD19J', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ,'tændrør'           => ens('tændrør', '', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LBXTCB2B08X (lille knallert mk-trade)', 'LBX (superprices aps)', 'LBXTCB2B98X020', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'andet'             => ens('andet', '', '', '', '')
       ...
       'begrænstransmis'   => ens('begrænstransmis', '', '', '', '')
      ,'begrænstænding'    => ens('begrænstænding', '', 'ja (28 km/t)', '', '')
      ,'begrænskarburator' => ens('begrænskarburator', '', '', '', '')
      ,'begrænsluftfilter' => ens('begrænsluftfilter', '', '', '', '')
      ,'begrænscontroller' => ens('begrænscontroller', '', '', '', '')
      ,'begrænsruller'     => ens('begrænsruller', '', '', '', '')
     ...
     'specielt'            => array(
      ...
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', 'XT50GY', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '45', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ...
      ,'maxeffektogheste'  => ens('maxeffektogheste', '', '', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', 'DENI PZ17G', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ,'tændrør'           => ens('tændrør', '', '', '', '')
      ...
      ,'kølervæske'        => ens('kølervæske', '', '', '', '')
       ...
       'transmissiontype'  => ens('transmissiontype', 'kæde', '', '', '(420)')
      ,'kobling'           => ens('kobling', 'manuel', '', '', '')
      ,'antalgear'         => ens('antalgear', '4', '', '', '')
      ,'gearratio'         => ens('gearratio', '', '', '', '')
      ,'tandhjulfor'       => ens('tandhjulfor', '14T', '', '', '')
      ,'tandhjulbag'       => ens('tandhjulbag', '58T', '', '', '')
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')

   ),'ekstra'              => array(
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', '', '', '', '___YCB3A')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'begrænscontroller' => ens('begrænscontroller', '', '', '', '')
      ,'begrænsruller'     => ens('begrænsruller', '', '', '', '')
      ,'begrænsindsug'     => ens('begrænsindsug', '', '', 'Indsnævring i indsugningsrøret ø 10 mm.', '')
      ,'begrænsudstødning' => ens('begrænsudstødning', '', '', '', '')
      ,'begrænsstelnum'    => ens('begrænsstelnum', '', '', '', '')
      ,'begrænsandet'      => ens('begrænsandet', '', '', '', '')
...
'download' => array(
    'kinroad chopper (XT50Q) brugermanual'      => 'kinroad_chopper_brugermanual.pdf'
   ,'kinroad chopper eldiagram'                 => 'kinroad_chopper_eldiagram.jpg'
   ,'XT50QT brugermanual'                       => 'kinroad_xt50qt_brugermanual.pdf'
   ,'XT50QT-2 brugermanual'                     => 'kinroad_xt50qt2_brugermanual.pdf'
   ,'XT50PY brugermanual'                       => 'kinroad_xt50py_brugermanual.pdf'
   ,'XT50GY brugermanual'                       => 'kinroad_xt50gy_brugermanual.pdf'
   ,'chopper common manual'                     => 'kinroad_chopper_common_manual.pdf'
   ,'scooter common manual'                     => 'kinroad_scooter_common_manual.pdf'

),'typegodkendelser' => array(
    'Kinroad Fresh Wind (XT50QT) EEC meget deltaljeret typegodkendelse'    => 'xt50qt_eectypegodkendelse.pdf'
...
// XT50QT aka fresh wind
// XT50QT-2 aka little fish (Superbike XT50QT-2)
// XT50QT-2A aka super fish
// XT50QT-5 (texas city ?)
// XT50QT-2 (texas free ?)

//LBXP - P = bike ?
   ,'(Nordic Bike) Prince XT50Q-A (-00, -01) 27 km/t E15781 (e4*2002/24*1135)' => 'typegodkendelser/Kinroad%20Prince%20%28E15781%29%20udstedt%2025-09-2006.pdf'
   ,'(Bike Danmark ApS) Chopper XT50Q-A 27 km/t E17644 (e4*2002/24*1135)' => 'typegodkendelser/Kinroad%20Chopper%2030%20%28E17644%29%20udstedt%2020-05-2009.pdf'
   ,'(Hilsonic Danmark) LBXP (-00, -01, -02, -03) Prince 45 km/t E14216 (e4*2002/24*0381)' => 'typegodkendelser/Kinroad%20Prince%20%28E14216%29%20udstedt%2028-04-2005.pdf'
   ,'(Bike Danmark Aps) LBXP Prince 45 km/t E14257 (e4*2002/24*0381)' => 'typegodkendelser/Kinroad%20Prince%20%28E14257%29%20udstedt%2010-05-2005.pdf'
   ,'(Fun Racing) LBXP (-00, -02) Prince 45 km/t E14357 (e4*2002/24*0381)' => 'typegodkendelser/Kinroad%20Prince%20%28E14357%29%20udstedt%2028-06-2005.pdf'
   ,'(CH-House Aps) Prince XT50Q (-00, -01, -02, -03) 45 km/t E15700 (e4*2002/24*0381)' => 'typegodkendelser/Kinroad%20Prince%20%28E15700%29%20udstedt%2004-08-2006.pdf'
