...
'adlybaboon' => array(
     ...
     'specielt'            => array(
      ...
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'silverfox', 'silver fox', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'RFLKSF05A7A014 (måske noget med 13")', 'RFLKST05A5A000', '', '')
      ...
      ,'producent'         => ens('producent', 'Her Chee Industrial Co., Ltd.', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
     ...
     'specielt'            => array(
      ...
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', '', '', '', '')
      ,'motortype'         => ens('motortype', '2 takt', '', '', 'der står godt nok 4 takt i servicemanualen men det er vist en fejl')
      ,'elmotorspec'       => ens('elmotorspec', '', '', '', '')
      ,'volume'            => ens('volume', '49.26', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '40,0', '', '', '')
      ...
      ,'tomgang'           => ens('tomgang', '', '', '', '')
      ,'nomieffektogheste' => ens('nomieffektogheste', '', '', '', '')
      ,'maxeffektogheste'  => ens('maxeffektogheste', '2,8', 'kw', '5500', '(ifølge servicemanual)')
      ,'moment'            => ens('moment', '4,75', 'nm', '5500', '(ifølge servicemanual)')
      ,'karburator'        => ens('karburator', '', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
      ,'tændrør'           => ens('tændrør', '', '', '', '')
      ...
      ,'affjedringfor'     => ens('affjedringfor', '', '', '', '')
      ,'affjedringbag'     => ens('affjedringbag', '', '', '', '')
      ,'bremserfor'        => ens('bremser', 'skive', '', '', '(TB-50 I)') . ens('bremser', 'dobbelt skive', '', '', '(TB-50 II)')
      ,'bremserbag'        => ens('bremser', 'tromle', '', '', '')
      ,'eger'              => ens('eger', '', '', '')
      ,'castervinkel'      => ens('castervinkel', '', '', '')
      ,'efterløb'          => ens('efterløb', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'RFLKST05A5A001', '', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '75', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'bagagevolume'      => ens('bagagevolume', '', '', '', '')
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Her Chee Industrial Co., Ltd.', '', '', '')
      ,'producent'         => ens('producent', '', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
...
'download' => array(
    'baboon 25 km/t servicemanual'  => 'adly_baboon_25_servicemanual.pdf'
   ,'baboon 45 km/t servicemanual'  => 'adly_baboon_45_servicemanual.pdf'
   ...
   ,'AT-50JT Silver Fox (SF) Panther (PA) 30 km/t E15584 (e4*92/61*0045)'                => 'typegodkendelser/Adly%20Moto%20-%20%28E15584%29%20udstedt%2027-06-2006.pdf'
   ,'Silver Fox AT-50JT 45 km/t E15284 (e4*92/61*0045)'                => 'typegodkendelser/Adly%20Moto%20Silver%20Fox%20%28E15284%29%20udstedt%2013-06-2006.pdf'
   ,'Baboon AT-50JT K 30 km/t E15399 (e4*90/61*0045)'                => 'typegodkendelser/Her%20Chee%20Baboon%20%28E15399%29%20udstedt%2018-05-2006.pdf'
   ,'Baboon D 45 km/t E14036 (e4*92/61*0045)'                => 'typegodkendelser/Her%20Chee%20Baboon%20%28E14036%29%20udstedt%2028-02-2005.pdf'

   ,'Gazelle D 45 km/t E14037 (e4*92/61*0044)'                => 'typegodkendelser/Her%20Chee%20Gazelle%20%28E14037%29%20udstedt%2028-02-2005.pdf'
   ,'Gazelle TB-50 K 30 km/t E15398 (e4*92/61*0044)'                => 'typegodkendelser/Her%20Chee%20Gazelle%20%28E15398%29%20udstedt%2018-05-2006.pdf'

   ,'Moto TB50/SS50/ST50 30 km/t E15585 (e4*92/61*0044)'                => 'typegodkendelser/Adly%20Moto%20-%20%28E15585%29%20udstedt%2027-06-2006.pdf'

   ,'D TB SS 45 km/t E10736 (e4*92/61*0044)'                => 'typegodkendelser/Her%20Chee%20-%20%28E10736%29%20udstedt%2026-07-2000.pdf'
   ,'D Jet / Cat / Silver Fox 45 km/t E10766 (e4*92/61*0045)'                => 'typegodkendelser/Her%20Chee%20-%20%28E10766%29%20udstedt%2014-08-2000.pdf'
