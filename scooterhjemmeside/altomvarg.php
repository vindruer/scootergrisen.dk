...
$title = "varg scootere med elektrisk motor";
$overskrift = "varg";
...
'vargbergen' => array(
     ...
     'specielt'            => array(
       'besked'            => ens('besked', 'det er ikke sikkert billedet er det rigtige', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'varg bergen', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'zhongshen', '', '', '')
      ,'scootertype'       => ens('scootertype', 'ZPM2000DQT', 'ZPM2000DQT-C', '', '')
      ...
      ,'elmotorspec'       => ens('elmotorspec', '48', '2000', '', '')
      ,'volume'            => ens('volume', '', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '', '', '', '')
      ...
      ,'producent'         => ens('producent', 'Zhongshen PEM', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
      ...
      ,'begrænscontroller' => ens('begrænscontroller', 'elektronisk i elektronikbox', '', '', '')
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'varg nora', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'zhongshen', '', '', '')
      ,'scootertype'       => ens('scootertype', 'ZPM350DQT', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ...
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', '', '', '', '')
      ,'motortype'         => ens('motortype', 'elektrisk', '', '', '')
      ,'elmotorspec'       => ens('elmotorspec', '48', '350', '', '')
      ,'volume'            => ens('volume', '', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '', '', '', '')
      ,'slaglængde'        => ens('slaglængde', '', '', '', '')
      ...
      ,'forbrug'           => ens('forbrug', '', '', '', '')
       ...
       'fælgfor'           => ens('fælg', '1.20', '14', '', '')
      ,'fælgbag'           => ens('fælg', '1.20', '14', '', '')
      ...
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '65', '', '', '')
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'varg oslo', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'zhongshen', '', '', '')
      ,'scootertype'       => ens('scootertype', 'ZPM2000DQT-2', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '30 og 45', '', '', '')
      ,'farver'            => ens('farver', '', '', '', '')
      ...
      ,'tomgang'           => ens('tomgang', '', '', '', '')
      ,'nomieffektogheste' => ens('nomieffektogheste', '', '', '', '')
      ,'maxeffektogheste'  => ens('maxeffektogheste', '2000', 'w', '', '')
      ,'moment'            => ens('moment', '', '', '', '')
      ,'karburator'        => ens('karburator', '', '', '', '')
      ,'brændstof indsp..' => ens('brændstof indsp..', '', '', '', '')
      ,'smøring'           => ens('smøring', '', '', '', '')
...
//   ,'' => ''
    ...
    'bergen 30 km/t E18027 (e4*2002/24*2177)'     => 'typegodkendelser/VARG%20Bergen%20%28E18027%29%20udstedt%2023-02-2010.pdf'
   ,'bergen 45 km/t E17838 (e4*2002/24*2177)'     => 'typegodkendelser/VARG%20Bergen%20%28E17838%29%20udstedt%2030-10-2009.pdf'
   ,'bergen 45 km/t 2 E 17838 (e4*2002/24*2177)'  => 'typegodkendelser/VARG%20Bergen%20%28E17838%29%20udstedt%2030-10-2009_2.pdf'
   ,'bergen 45 km/t 2? E 17838 (e4*2002/24*2177)' => 'typegodkendelser/VARG%20Bergen%20%28E17838%29%20udstedt%2030-10-2009%282%29.pdf'
   ,'nora 30 km/t E17839 (e4*2002/24*1838)'       => 'typegodkendelser/VARG%20Nora%20%28E17839%29%20udstedt%2030-10-2009.pdf'
   ,'nora 30 km/t 2 E 17839 (e4*2002/24*1838)'    => 'typegodkendelser/VARG%20Nora%20%28E17839%29%20udstedt%2030-10-2009_2.pdf'
   ,'nora 30 km/t 2? E 17839 (e4*2002/24*1838)'   => 'typegodkendelser/VARG%20Nora%20%28E17839%29%20udstedt%2030-10-2009%282%29.pdf'
   ,'oslo 30 km/t E18028 (e4*2002/24*2176)'       => 'typegodkendelser/VARG%20Oslo%20%28E18028%29%20udstedt%2023-02-2010.pdf'
   ,'oslo 45 km/t E17837 (e4*2002/24*2176)'       => 'typegodkendelser/VARG%20Oslo%20%28E17837%29%20udstedt%2030-10-2009.pdf'
   ,'oslo 45 km/t 2 E 17837 (e4*2002/24*2176)'    => 'typegodkendelser/VARG%20Oslo%20%28E17837%29%20udstedt%2030-10-2009_2.pdf'
   ,'oslo 45 km/t 2? E 17837 (e4*2002/24*2176)'   => 'typegodkendelser/VARG%20Oslo%20%28E17837%29%20udstedt%2030-10-2009%282%29.pdf'
