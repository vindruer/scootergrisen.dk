...
$title = "solo scootere med elektrisk motor";
$overskrift = "solo";
...
', '', '', '')
       ...
       'model'             => ens('model', 'solo electra', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', '720', '', '', '')
      ...
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')
       ...
       'motormodel'        => ens('motormodel', 'bosch', '', '', '')
      ,'motortype'         => ens('motortype', 'elektrisk', '', '', '')
      ,'elmotorspec'       => ens('elmotorspec', '24', '750', '', '')
      ,'volume'            => ens('volume', '', '', '', '')
      ,'køling'            => ens('køling', '', '', '', '')
      ,'boring'            => ens('boring', '', '', '', '')
      ...
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'Brd. Kildemoes Cykelfabrik', '', '', '')
      ,'producent'         => ens('producent', 'SOLO-Kleinmotoren GmbH', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
     ...
     'specielt'            => array(
       'besked'            => ens('besked', '
Jeg ved ikke om denne model nogensinde har været solgt i danmark.

'.ahref('http://www.hercules-bikes.de/de/Hercules-Historie-Fahrraeder-und-Ebikes-178.html').'
', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'solo hercules', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
