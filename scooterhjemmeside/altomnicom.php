...
$title = "Nicom scootere med elektrisk motor";
$overskrift = "Nicom";
...
'nicomtdr48k15' => array(
     ...
     'specielt'            => array(
       ...
       'model'             => ens('model', 'nicom TDR48K15', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', 'elvin', '', '', '')
      ,'scootertype'       => ens('scootertype', 'TDR48K15', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '8000', '12600', '', '')
      ,'hastighed'         => ens('hastighed', '25', '', '', '')
      ,'farver'            => ens('farver', 'gul rød mørkeblå lyseblå orange sølv', '', '', '')
      ,'forhandlere'       => ens('forhandlere', 'http://www.klimabutikken.dk/elknallert', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'LXX', '', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '60', '', '', '')
      ,'vægttotal'         => ens('vægttotal', '185', '', '', '')
      ...
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'ProCure A/S', 'Jørgen Thomasen ApS', '', '')
      ,'producent'         => ens('producent', 'Zhejiang Nicom Electric Vehicle Co., Ltd.', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
      ...
      ,'begrænsandet'      => ens('begrænsandet', 'elektronisk i motoren', '', '', '')
...
'download' => array(
    'nicom brugermanual'       => 'nicom_topprince_brugermanual.pdf'

),'typegodkendelser' => array(
    'nicom 25 km/t E17166 (e4*2002/24*1914) 1'    => 'typegodkendelser/NICOM%20-%20%28E17166%29%20udstedt%2003-07-2008.pdf'
   ,'nicom 25 km/t E18270 (e4*2002/24*1914) 2'    => 'typegodkendelser/NICOM%20-%20%28E18270%29%20udstedt%2002-06-2010.pdf'
