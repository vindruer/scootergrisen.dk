...
config. OffsetX			= 30		// Horizontal offset of left-top corner from mousepointer
...
function tt_Browser()
{
	...
	if(tt_ie || n6 || tt_op || w3c)
	{
		if(tt_body && tt_db)
		{
			...
			tt_Err("tooltip.js skal være lige efter <body>"
					+ ".", false);
	}
	tt_db = null;
	return false;
