...
$metadescription = "forklaring af spændingsregulatoren på en scooter som begrænser spændingen fra generatoren og laver vekselstrøm om til jævnstrøm";
...
Her ses spændingsregulator data for Kymco Super 8 4T.
'.visbilled('1', 'billed2307.jpg', 'kymco super 8 4T spændingsregulator data', false, true).'
...
Spændingsregulatoren på en Kymco Super 8 4T er af typen "Single-phase full-wave SCR".
...
'.visbilled('1', 'billed0718.jpg', 'spændingsregulator kymco super 8 4T resin', false, true).'
Resin er rimelig hårdt ved stuetemperatur men det kan blødgøres med en varmeblæser og fjernes med en lille skruetrækker.
'.visbilled('1', 'billed0628.jpg', 'spændingsregulator kymco super 8 4T resin', false, true).'
Når resinen er fjernet kan man skrue en skrue ud og fjerne elektronikken fra huset.
'.visbilled('1', 'billed0629.jpg', 'spændingsregulator kymco super 8 4T resin fjernet', false, true).'
...
'.visbilled('1', 'billed0631.jpg', 'spændingsregulator kymco super 8 4T køleplade', false, true).'
...
'.visbilled('1', 'billed0630.jpg', 'spændingsregulator kymco super 8 4T ensretter thyristor SCR', false, true).'
De 4 runde med hvid kant er ensrettere.
'.visbilled('1', 'billed0632.jpg', 'spændingsregulator kymco super 8 4T ensrettere køleplade', false, true).'
...
'.visbilled('1', 'billed0633.jpg', 'spændingsregulator kymco super 8 4T thyristor SCR zener diode modstand kapacistor transistor', false, true).'
Her ses hvordan spændingsregulatoren er forbundet til generator, tændingslås, sikring og batteri.
'.visbilled('1', 'billed0635.jpg', 'spændingsregulator kymco super 8 4T ledningsnet', false, true).'
').'
'
