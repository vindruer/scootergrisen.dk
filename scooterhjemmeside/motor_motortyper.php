...
'.visbilled('1', 'billed0947.jpg', '139QMB 4 takt 50 cm³ tvunget blæsekølet forbrændingsmotor til scooter', false, true).'
'.visbilled('1', 'billed3271.jpg', '139QMB 4 takt 50 cm³ tvunget blæsekølet forbrændingsmotor til scooter', false, true).'
...
'.visbilled('1', 'billed1047.jpg', '139QMB 4 takt 50 cm³ tvunget blæsekølet forbrændingsmotor til scooter', false, true).'
'.
galleriholder(array(
    galleri('highslide', '', 'billed3787.jpg', array('Kymco Agility 4 takt motor', 'komplet motorenhed på centerstøtteben og baghjul'))
   ,galleri('highslide', '', 'billed3786.jpg', array('Kymco Agility 4 takt motor', 'komplet motorenhed på centerstøtteben og baghjul'))
))
.'
...
'.visbilled('1', 'billed0948.jpg', '152QMI 4 takt 125 cm³ tvunget blæsekølet forbrændingsmotor til scooter', false, true).'
'
...
'.visbilled('1', 'billed0946.jpg', '139FMA 4 takt 50 cm³ passiv vindkølet forbrændingsmotor til knallert', false, true).'
Her ses 139FMB som er vindkølet med kædetræk.
'.galleriholder(array(galleri('highslidestandard', 'billed1557.jpg', 'billed1557.jpg', '139FMB 4 takt 50 cm³ passiv vindkølet forbrændingsmotor til knallert'))). '
Her ses 139FMB-2 som er vindkølet med kædetræk.
Findes på Apollo Orion 30 og 36.
'.visbilled('1', 'billed0949.jpg', '139FMB-2 4 takt 50 cm³ passiv vindkølet forbrændingsmotor til knallert', false, true).'

Her ses 1P57FMJ som er 150 cm³ vindkølet med kædetræk.
'.visbilled('1', 'billed3172.jpg', '1P57FMJ 4 takt 150 cm³ passiv vindkølet forbrændingsmotor til knallert', false, true).'
'
...
'.visbilled('1', 'billed3857.jpg', 'Motori Minarelli XF 4 takt 50 cm³ væskekølet forbrændingsmotor til Yamaha scooter', false, true).'
'
