...
$title = "xingyue scootere med 50 cm³ og elektrisk motor";
$overskrift = "xingyue";
...
'seeyesdmb09a' => array(
     ...
     'specielt'            => array(
       'besked'            => ens('besked', 'e8*2002/24*0010', '', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'Seeyes DMB09A', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', '', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ,'hastighed'         => ens('hastighed', '45', '', '', '35-43 km/t')
      ,'farver'            => ens('farver', '', '', '', '')
      ,'forhandlere'       => ens('forhandlere', '', '', '', '')

   ),'motor'               => array(
       'motormodel'        => ens('motormodel', 'XYSWXDM-48', 'børsteløs', '', '')
      ...
      ,'batterispec1'      => ens('batterispec1', '48', '25', 'bly-syre', '')
      ,'batterispec2'      => ens('batterispec2', '', '', '', '')
      ,'batterivægt'       => ens('batterivægt', '', '', '', '')
      ,'batterilevetid'    => ens('batterilevetid', '', 'mere end 550', '', '')
      ...
      ,'rækkevidde'        => ens('rækkevidde', '', '60-70', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'L4BDB99C093001 (45 km/t Seeyes)', '', '', '')
      ...
      ,'bakgear'           => ens('bakgear', '', '', '', '')
      ,'importør'          => ens('importør', 'PAP Emballage & Display ApS', 'Miljø-Scooter.dk', '', '')
      ,'producent'         => ens('producent', 'China Xingyue Electric Bicycle Co Ltd', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
     ...
     'specielt'            => array(
       'besked'            => ens('besked', '3 hjulet med tag', 'e4*2002/24*1619*00', '', '')

   ),'generelt'            => array(
       'model'             => ens('model', 'Xingyue XY50ZK', '', '', '')
      ,'ogsåkaldet'        => ens('ogsåkaldet', '', '', '', '')
      ,'scootertype'       => ens('scootertype', '', '', '', '')
      ,'varianter'         => ens('varianter', '', '', '', '')
      ,'pris'              => ens('pris', '', '', '', '')
      ...
      ,'reduktionsratio'   => ens('reduktionsratio', '', '', '', '')
       ...
       'stel'              => ens('stel', '', '', '', '')
      ,'stelnummer'        => ens('stelnummer', 'L4SKGADC672900138 (AE9760)', '', '', '')
      ,'udstødning'        => ens('udstødning', '', '', '', '')
      ,'euroemission'      => ens('euroemission', '', '', '', '')
      ,'vægttør'           => ens('vægttør', '', '', '', '')
      ,'vægtkørerklar'     => ens('vægtkørerklar', '', '', '', '')
      ...
      ,'producent'         => ens('producent', 'zhejiang xingyue vehicle co., ltd.', '', '', '')
      ,'andet'             => ens('andet', '', '', '', '')
...
//   ,'' => ''
    ...
    'XINGYUE XYDM82 (stor knallert) 30 km/t E18870 (e4*2002/24*1870)'         => 'typegodkendelser/XINGYUE%20DM82%20%28E18870%29%20udstedt%2017-01-2011.pdf'
