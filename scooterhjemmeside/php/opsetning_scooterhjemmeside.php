...
$setup['rssfeed']                = "/$setup[datamappe]/php/rss.php";

$setup['vissprog']               = 1;
$setup['visreklame']             = 1;
$setup['visspotlys']             = 1;
$setup['spotlysantal']           = 4;
$setup['counterogsocialemedier'] = 1;
$setup['eftertitle']             = '';
$setup['footertekst']            = 'scootergrisen.dk';
$setup['unimenuer']              = array();

//$setup['blablabla_ikon']               = 'ikoner/ikon_scootergrisen.png';
$setup['sideikon']               = 'ikoner/scootergrisen64.png';
$setup['chartid']                = '139030';
$setup['msvalidate']             = '3F759ED51FA4F6FB8F2962FF0C1FD4A2';

$setup['rsschanneltitle']        = 'Scootergrisen nyt'; // Det som kommer til at slå i Bookmarks toolbar når man tilføjer det i en browser
$setup['rsschanneldescription']  = 'Nyheder fra Scootergrisen';

$kort = '/' . $setup['datamappe'] . '/';

$setup['smaikoner'] = array(
    array($setup['l_smaikoner_forum'], 'http://scootergrisen.dk/forum/', 'ikoner/ikon_forum.png', '52', '16')
   ,array($setup['l_smaikoner_start'], $kort . 'start.php', 'ikoner/ikon_start.png', '16', '16')
   ,array($setup['l_smaikoner_nyheder'], $kort . 'nyheder.php', 'ikoner/ikon_nyheder.png', '16', '16')
   ,array($setup['l_smaikoner_kontakt'], $kort . 'kontakt.php', 'ikoner/ikon_kontakt.png', '16', '16')
   ,array($setup['l_smaikoner_introduktion'], $kort . 'introduktion.php', 'ikoner/ikon_introduktion.png', '16', '16')
   ,array($setup['l_smaikoner_tilfeldig'], $kort . 'tilfeldig.php', 'ikoner/ikon_tilfeldig.png', '16', '16')
   ,array($setup['l_smaikoner_download'], $kort . 'download.php', 'ikoner/go_down.png', '16', '16')
   ,array($setup['l_smaikoner_typegodkendelser'], $kort . 'typegodkendelser.php', 'ikoner/ikon_typegodkendelser.png', '16', '16')
   ,array($setup['l_smaikoner_teoriprove'], $kort . 'teoriprove.php', 'ikoner/ikon_teoriprove.png', '16', '16')
   ,array($setup['l_smaikoner_begrensninger'], $kort . 'begrensninger.php', 'ikoner/ikon_begrensninger.png', '16', '16')
   ,array($setup['l_smaikoner_galleri'], $kort . 'galleri.php', 'ikoner/ikon_galleri.png', '16', '16')
   ,array($setup['l_smaikoner_kamera'], $kort . 'kamera.php', 'ikoner/ikon_kamera.png', '16', '16')
   ,array($setup['l_smaikoner_vinchecker'], $kort . 'vinchecker.php', 'ikoner/ikon_vinchecker.png', '38', '16')
   ,array($setup['l_smaikoner_links'], $kort . 'links.php', 'ikoner/ikon_links.png', '16', '16')
   ,array($setup['l_smaikoner_stederidanmark'], $kort . 'stederidanmark.php', 'ikoner/ikon_stederidanmark.png', '16', '16')
   ,array($setup['l_smaikoner_vinterrad'], $kort . 'vinterrad.php', 'ikoner/ikon_vinterrad.png', '16', '16')
   ,array($setup['l_smaikoner_karburator'], $kort . 'karburator.php', 'ikoner/ikon_karburator.png', '16', '16')
   ,array($setup['l_smaikoner_nummerplade'], $kort . 'nummerplade.php', 'ikoner/ikon_nummerplade.png', '16', '16')
   ,array($setup['l_smaikoner_billeder'], $kort . 'billeder.php', 'ikoner/ikon_billeder.png', '16', '16')
   ,array($setup['l_smaikoner_videoer'], $kort . 'videoer.php', 'ikoner/ikon_videoer.png', '16', '16')
   ,array($setup['l_smaikoner_serivefejlfindingintroduktion'], $kort . 'service_fejlfinding_introduktion.php', 'ikoner/ikon_fejlfinding.png', '63', '16')
   ,array($setup['l_smaikoner_loveogregler'], $kort . 'loveogregler.php', 'ikoner/ikon_loveogregler.png', '16', '16')
   ,array($setup['l_smaikoner_registrering'], $kort . 'registrering.php', 'ikoner/ikon_registrering.png', '16', '16')
   ,array($setup['l_smaikoner_tendror'], $kort . 'tendror.php', 'ikoner/ikon_tendror.png', '16', '16')
);
...
$setup['reklamer'] = array(
      ...
      ,array('FantomBike.dk',       'http://www.fantombike.dk',      'www.fantombike.dk2.png')
      ...
      ,array('Speedline.dk',        'http://www.speedline.dk',       'www.speedline.dk.png')
   );

$setup['spotlys'] = array(
   array(
       '/scooterhjemmeside/reservedelstegninger.php'
      ,'spotlys/reservedelstegninger.png'
      ,$setup['l_spotlys_reservedelstegninger']
      ,$setup['l_spotlys_reservedelstegninger_description']
   ), array(
       '/scooterhjemmeside/vinterrad.php'
      ,'spotlys/vinterrad.png'
      ,$setup['l_spotlys_vinterrad']
      ,$setup['l_spotlys_vinterrad_description']
   ), array(
       '/scooterhjemmeside/service_fejlfinding_introduktion.php'
      ,'spotlys/service_fejlfinding_introduktion.png'
      ,$setup['l_spotlys_service_fejlfinding_introduktion']
      ,$setup['l_spotlys_service_fejlfinding_introduktion_description']
   ), array(
       '/scooterhjemmeside/download.php'
      ,'spotlys/download.png'
      ,$setup['l_spotlys_download']
      ,$setup['l_spotlys_download_description']
   ), array(
       '/scooterhjemmeside/registrering.php'
      ,'spotlys/registrering.png'
      ,$setup['l_spotlys_registrering']
      ,$setup['l_spotlys_registrering_description']
   ), array(
       '/scooterhjemmeside/tendror.php'
      ,'spotlys/tendror.png'
      ,$setup['l_spotlys_tendror']
      ,$setup['l_spotlys_tendror_description']
   ), array(
       '/scooterhjemmeside/begrensninger.php'
      ,'spotlys/begrensninger.png'
      ,$setup['l_spotlys_begrensninger']
      ,$setup['l_spotlys_begrensninger_description']
   ), array(
       '/scooterhjemmeside/teoriprove.php'
      ,'spotlys/teoriprove.png'
      ,$setup['l_spotlys_teoriprove']
      ,$setup['l_spotlys_teoriprove_description']
   ), array(
       '/scooterhjemmeside/karburator.php'
      ,'spotlys/karburator.png'
      ,$setup['l_spotlys_karburator']
      ,$setup['l_spotlys_karburator_description']
   ), array(
       '/scooterhjemmeside/vinchecker.php'
      ,'spotlys/vinchecker.png'
      ,$setup['l_spotlys_vinchecker']
      ,$setup['l_spotlys_vinchecker_description']
   ), array(
       '/scooterhjemmeside/lyd.php'
      ,'spotlys/underholdninglyd.png'
      ,$setup['l_spotlys_lyd']
      ,$setup['l_spotlys_lyd_description']
   ), array(
       '/scooterhjemmeside/billeder.php'
      ,'spotlys/billeder.png'
...
if($GLOBALS['setup']['lokalt']){
   ...
   $top10 = '<span class="topside fontsize_large bold" title="Blandt top 10 sider med flest unikke sidevisninger (siden cirka)">Top 10</span>';
   $top20 = '<span class="topside fontsize_medium bold" title="Blandt top 20 sider med flest unikke sidevisninger (siden cirka)">Top 20</span>';
   $top30 = '<span class="topside fontsize_small bold" title="Blandt top 30 sider med flest unikke sidevisninger (siden cirka)">Top 30</span>';
   $top40 = '<span class="topside fontsize_xsmall bold" title="Blandt top 40 sider med flest unikke sidevisninger (siden cirka)">Top 40</span>';
   $top50 = '<span class="topside fontsize_xxsmal bold" title="Blandt top 50 sider med flest unikke sidevisninger (siden cirka)">Top 50</span>';
...
$setup['menu'] = array(
     ...
     $setup['l_m_forummenu'] => array(
       $setup['l_m_forummenu_boardindex'] . $top10  => array('/forum/index.php'                           => $setup['l_m_forummenu_boardindex_description'], 'thumbnail' => 'billed3738.jpg')
      ,$setup['l_m_forummenu_activetopics']         => array('/forum/search.php?search_id=active_topics'  => $setup['l_m_forummenu_activetopics_description'], 'thumbnail' => 'billed3739.jpg')
      ,$setup['l_m_forummenu_sog']                  => array('/forum/search.php'                          => $setup['l_m_forummenu_sog_description'], 'thumbnail' => 'billed3740.jpg')

   ),$setup['l_m_hovedmenu'] => array(
       $setup['l_m_hovedmenu_forsiden'] . $top10    => array($kort . 'index.php'                                      => $setup['l_m_hovedmenu_forsiden_description'], 'thumbnail' => 'forsiden.jpg')
      ...
      ,$setup['l_m_hovedmenu_nyheder'] . $top50     => array($kort . 'nyheder.php'                           => $setup['l_m_hovedmenu_nyheder_description'], 'thumbnail' => 'billed3233.jpg')
      ...
      ,$setup['l_m_hovedmenu_kontakt'] . $top40              => array($kort . 'kontakt.php'                  => $setup['l_m_hovedmenu_kontakt_description'], 'thumbnail' => 'billed3239.jpg')
      ...
      ,$setup['l_m_interaktive_omregn'] . $top40               => array($kort . 'omregn.php'                      => $setup['l_m_interaktive_omregn_description'], 'thumbnail' => 'billed2262.jpg')
      ...
      ,array(
           $setup['l_m_scootermerker_1'] => array(
            ...
            ,$setup['l_m_scootermerker_1_apollo'] . $top40            => array($kort . 'altomapollo.php'                 => $setup['l_m_scootermerker_1_apollo_description'], 'logo' => 'logo_apollo.png')
            ,$setup['l_m_scootermerker_1_aprilia'] . $top40           => array($kort . 'altomaprilia.php'                => $setup['l_m_scootermerker_1_aprilia_description'], 'logo' => 'logo_aprilia.png')
            ...
            ,$setup['l_m_scootermerker_2_gilera'] . $top50            => array($kort . 'altomgilera.php'                 => $setup['l_m_scootermerker_2_gilera_description'], 'logo' => 'logo_gilera.png')
            ...
            ,$setup['l_m_scootermerker_2_grace']                      => array($kort . 'altomgrace.php'                  => $setup['l_m_scootermerker_2_grace_description'], 'logo' => 'logo_grace.png')
            ...
            ,$setup['l_m_scootermerker_3_kinroad'] . $top40           => array($kort . 'altomkinroad.php'                => $setup['l_m_scootermerker_3_kinroad_description'], 'logo' => 'logo_kinroad.png')
            ...
            ,$setup['l_m_scootermerker_3_kymco'] . $top40             => array($kort . 'altomkymco.php'                  => $setup['l_m_scootermerker_3_kymco_description'], 'logo' => 'logo_kymco.png')
            ...
            ,$setup['l_m_scootermerker_3_longjia'] . $top40           => array($kort . 'altomlongjia.php'                => $setup['l_m_scootermerker_3_longjia_description'], 'logo' => 'logo_longjia.png')
            ...
            ,$setup['l_m_scootermerker_4_skyteam'] . $top50           => array($kort . 'altomskyteam.php'                => $setup['l_m_scootermerker_4_skyteam_description'], 'logo' => 'logo_skyteam.png')
            ...
            ,$setup['l_m_scootermerker_4_suzuki'] . $top50            => array($kort . 'altomsuzuki.php'                 => $setup['l_m_scootermerker_4_suzuki_description'], 'logo' => 'logo_suzuki.png')
            ,$setup['l_m_scootermerker_4_swap']                       => array($kort . 'altomswap.php'                   => $setup['l_m_scootermerker_4_swap_description'], 'logo' => 'logo_swap.png')
            ,$setup['l_m_scootermerker_4_sym'] . $top50               => array($kort . 'altomsym.php'                    => $setup['l_m_scootermerker_4_sym_description'], 'logo' => 'logo_sym.png')
            ...
            ,$setup['l_m_scootermerker_5_tms'] . $top50               => array($kort . 'altomtms.php'                    => $setup['l_m_scootermerker_5_tms_description'], 'logo' => 'logo_tms.png')
            ...
            ,$setup['l_m_scootermerker_5_yamaha'] . $top40            => array($kort . 'altomyamaha.php'                 => $setup['l_m_scootermerker_5_yamaha_description'], 'logo' => 'logo_yamaha.png')
      ...
      ,$setup['l_m_scootermerker_galleri_manglerdata'] . $top40 => array($kort . 'galleri_manglerdata.php'         => $setup['l_m_scootermerker_galleri_manglerdata_description'], 'thumbnail' => 'billed3446.jpg')
      ...
      ,$setup['l_m_scootermerker_elektriskescootere']          => array($kort . 'elektriskescootere.php'          => $setup['l_m_scootermerker_elektriskescootere_description'], 'thumbnail' => 'elektriskescootere.jpg')
       ...
       array(
         $setup['l_m_scooterensdele_2taktmotor'] => array(
            ...
            ,$setup['l_m_scooterensdele_2taktmotor_ditech']  . $top50            => array($kort . 'specielt_ditech.php'             => $setup['l_m_scooterensdele_2taktmotor_ditech_description'], 'thumbnail' => 'billed2665.jpg')
         ),$setup['l_m_scooterensdele_4taktmotor'] => array(
             $setup['l_m_scooterensdele_4taktmotor_de4takter'] . $top50          => array($kort . 'motor_de4takter.php'             => $setup['l_m_scooterensdele_4taktmotor_de4takter_description'], 'thumbnail' => 'billed3289.jpg')
      ...
      ,$setup['l_m_scooterensdele_brandstofindsprojtning'] . $top50  => array($kort . 'brandstofindsprojtning.php'      => $setup['l_m_scooterensdele_brandstofindsprojtning_description'], 'thumbnail' => 'billed2236.jpg')
      ...
      ,$setup['l_m_scooterensdele_tendror'] . $top20        => array($kort . 'tendror.php'                     => $setup['l_m_scooterensdele_tendror_description'], 'thumbnail' => 'billed2250.jpg')
       ...
       array(
         $setup['l_m_service_fejlfinding'] => array(
            ...
            ,$setup['l_m_vesker_olie'] . $top40              => array($kort . 'olie.php'                        => $setup['l_m_vesker_olie_description'], 'thumbnail' => 'billed2261.jpg')
      ...
      ,$setup['l_m_service_olie']    . $top50                        => array($kort . 'service_olie.php'                => $setup['l_m_service_olie_description'], 'thumbnail' => 'billed2283.jpg')
      ...
      array(
           $setup['l_m_specielt_manglerdata'] => array(
             $setup['l_m_specielt_manglerdata_benelli491gt']              => array($kort . 'manglerdata.php#benelli491gt'            => $setup['l_m_specielt_manglerdata_benelli491gt_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_daelimsfive']               => array($kort . 'manglerdata.php#daelimsfive'            => $setup['l_m_specielt_manglerdata_daelimsfive_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_fanticchopper']             => array($kort . 'manglerdata.php#fanticchopper'            => $setup['l_m_specielt_manglerdata_fanticchopper_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_futongft50qt3']             => array($kort . 'manglerdata.php#futongft50qt3'            => $setup['l_m_specielt_manglerdata_futongft50qt3_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_huasahs50qt7']              => array($kort . 'manglerdata.php#huasahs50qt7'            => $setup['l_m_specielt_manglerdata_huasahs50qt7_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_jmstarjsd50qt27']           => array($kort . 'manglerdata.php#jmstarjsd50qt27'            => $setup['l_m_specielt_manglerdata_jmstarjsd50qt27_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_jomanitrogt4']              => array($kort . 'manglerdata.php#jomanitrogt4'            => $setup['l_m_specielt_manglerdata_jomanitrogt4_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_kyburzdxp']                 => array($kort . 'manglerdata.php#kyburzdxp'            => $setup['l_m_specielt_manglerdata_kyburzdxp_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_lyrick525']                 => array($kort . 'manglerdata.php#lyrick525'            => $setup['l_m_specielt_manglerdata_lyrick525_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_mgbdelivery']               => array($kort . 'manglerdata.php#mgbdelivery'            => $setup['l_m_specielt_manglerdata_mgbdelivery_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_qunshenge808']              => array($kort . 'manglerdata.php#qunshenge808'            => $setup['l_m_specielt_manglerdata_qunshenge808_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_rmcspiga']                  => array($kort . 'manglerdata.php#rmcspiga'            => $setup['l_m_specielt_manglerdata_rmcspiga_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_simsonalbatros']            => array($kort . 'manglerdata.php#simsonalbatros'            => $setup['l_m_specielt_manglerdata_simsonalbatros_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_socaflea']                  => array($kort . 'manglerdata.php#socaflea'            => $setup['l_m_specielt_manglerdata_socaflea_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_standardmotoeasyrider']     => array($kort . 'manglerdata.php#standardmotoeasyrider'            => $setup['l_m_specielt_manglerdata_standardmotoeasyrider_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_thumpstarroadripper']       => array($kort . 'manglerdata.php#thumpstarroadripper'            => $setup['l_m_specielt_manglerdata_thumpstarroadripper_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_transportel1200combi']      => array($kort . 'manglerdata.php#transportel1200combi'            => $setup['l_m_specielt_manglerdata_transportel1200combi_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_tugger']                    => array($kort . 'manglerdata.php#tugger'            => $setup['l_m_specielt_manglerdata_tugger_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_xiaofeiluhrtk122']          => array($kort . 'manglerdata.php#xiaofeiluhrtk122'            => $setup['l_m_specielt_manglerdata_xiaofeiluhrtk122_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_yadeaem05']                 => array($kort . 'manglerdata.php#yadeaem05'            => $setup['l_m_specielt_manglerdata_yadeaem05_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__baotianswitch']            => array($kort . 'manglerdata.php#_baotianswitch'            => $setup['l_m_specielt_manglerdata__baotianswitch_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__baotianv4']                => array($kort . 'manglerdata.php#_baotianv4'            => $setup['l_m_specielt_manglerdata__baotianv4_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_dongfangcrane']             => array($kort . 'manglerdata.php#dongfangcrane'            => $setup['l_m_specielt_manglerdata_dongfangcrane_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__eastdragon']               => array($kort . 'manglerdata.php#_eastdragon'            => $setup['l_m_specielt_manglerdata__eastdragon_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata_hmnoget']                   => array($kort . 'manglerdata.php#hmnoget'            => $setup['l_m_specielt_manglerdata_hmnoget_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__jensenchopper']            => array($kort . 'manglerdata.php#_jensenchopper'            => $setup['l_m_specielt_manglerdata__jensenchopper_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__jonwayfreedom']            => array($kort . 'manglerdata.php#_jonwayfreedom'            => $setup['l_m_specielt_manglerdata__jonwayfreedom_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__macalcity']                => array($kort . 'manglerdata.php#_macalcity'            => $setup['l_m_specielt_manglerdata__macalcity_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__pgobubu']                  => array($kort . 'manglerdata.php#_pgobubu'            => $setup['l_m_specielt_manglerdata__pgobubu_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__sanilisl50qt5']            => array($kort . 'manglerdata.php#_sanilisl50qt5'            => $setup['l_m_specielt_manglerdata__sanilisl50qt5_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__sanilisl50qt8']            => array($kort . 'manglerdata.php#_sanilisl50qt8'            => $setup['l_m_specielt_manglerdata__sanilisl50qt8_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__tobiliner50tq']            => array($kort . 'manglerdata.php#_tobiliner50tq'            => $setup['l_m_specielt_manglerdata__tobiliner50tq_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__yadeaouhu']                => array($kort . 'manglerdata.php#_yadeaouhu'            => $setup['l_m_specielt_manglerdata__yadeaouhu_description'], 'thumbnail' => 'logo_x.jpg')
            ,$setup['l_m_specielt_manglerdata__yibensport']               => array($kort . 'manglerdata.php#_yibensport'            => $setup['l_m_specielt_manglerdata__yibensport_description'], 'thumbnail' => 'logo_x.jpg')
         )
      )
//       array(
