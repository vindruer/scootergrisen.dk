...
$setup['menu'] = array(
     ...
     $setup['l_m_hovedmenu'] => array(
      ...
      ,$setup['l_m_interaktive_vinchecker']                    => array($kort . '/' . 'vinchecker.php'                  => $setup['l_m_interaktive_vinchecker_description'], 'thumbnail' => 'billed3241.jpg')
      ...
      ,$setup['l_m_oplysninger_ordbog']                     => array($kort . '/' . 'ordbog.php'                      => $setup['l_m_oplysninger_ordbog_description'], 'thumbnail' => 'billed2615.jpg')
       ...
       $setup['l_m_dokumenter_download']                       => array($kort . '/' . 'download.php'                          => $setup['l_m_dokumenter_download_description'], 'thumbnail' => 'billed3234.jpg')
      ...
      ,array(
           $setup['l_m_scootermerker_1'] => array(
            ...
            ,$setup['l_m_scootermerker_2_giantco']                    => array($kort . '/' . 'altomgiantco.php'                => $setup['l_m_scootermerker_2_giantco_description'], 'logo' => 'logo_giantco.png')
            ...
            ,$setup['l_m_scootermerker_3_norsjo']                     => array($kort . '/' . 'altomnorsjo.php'                 => $setup['l_m_scootermerker_3_norsjo_description'], 'logo' => 'logo_norsjo.png')
             ...
             $setup['l_m_scootermerker_4_peugeot']                    => array($kort . '/' . 'altompeugeot.php'                => $setup['l_m_scootermerker_4_peugeot_description'], 'logo' => 'logo_peugeot.png')
            ...
            ,$setup['l_m_scootermerker_4_pgo']                        => array($kort . '/' . 'altompgo.php'                    => $setup['l_m_scootermerker_4_pgo_description'], 'logo' => 'logo_pgo.png')
            ,$setup['l_m_scootermerker_4_piaggio']                    => array($kort . '/' . 'altompiaggio.php'                => $setup['l_m_scootermerker_4_piaggio_description'], 'logo' => 'logo_piaggio.png')
            ,$setup['l_m_scootermerker_4_puch']                       => array($kort . '/' . 'altompuch.php'                   => $setup['l_m_scootermerker_4_puch_description'], 'logo' => 'logo_puch.png')
      ...
      ,$setup['l_m_scootermerker_atv']                         => array($kort . '/' . 'atv.php'                         => $setup['l_m_scootermerker_atv_description'], 'thumbnail' => 'billed3442.jpg')
      ,$setup['l_m_scootermerker_sammenlign']                  => array($kort . '/' . 'sammenlign.php'                  => $setup['l_m_scootermerker_sammenlign_description'], 'thumbnail' => 'billed3255.jpg')
       ...
       $setup['l_m_interaktive_teoriprove']                    => array($kort . '/' . 'teoriprove.php'                  => $setup['l_m_interaktive_teoriprove_description'], 'thumbnail' => 'billed2382.jpg')
